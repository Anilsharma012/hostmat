...
const ADCP_INSTRUCTORS = [
  { name: "Kumar Sir", expertise: "Mentor (VARC)", image: one },
  { name: "Manish Sir", expertise: "Mentor (Quant/LRDI)", image: two },
  { name: "Neeraj Sir", expertise: "Mentor (Quant/LRDI)", image: three },
];
